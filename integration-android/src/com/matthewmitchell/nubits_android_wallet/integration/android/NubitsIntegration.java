...
package com.matthewmitchell.nubits_android_wallet.integration.android;
 ...
 */
public final class NubitsIntegration
{
	...
	{
		final Intent intent = makeNubitsUriIntent(address, null);
	...
	{
		final Intent intent = makeNubitsUriIntent(address, amount);
	...
	{
		final StringBuilder uri = new StringBuilder("Nu:");
		if (address != null)
			uri.append(address);
		if (amount != null)
