...
import com.matthewmitchell.nubits_android_wallet.ui.BlockchainData;
import com.matthewmitchell.nubits_android_wallet.ui.BlockchainLoader;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService, OnLoadCompleteListener<BlockchainData>
{
    ...
    private void notifyCoinsReceived(@Nullable final Address from, @Nonnull final Coin amount)
    {
        ...
        final String tickerMsg = getString(R.string.notification_coins_received_msg, nbtFormat.format(amount)) + msgSuffix;
        final String msg = getString(R.string.notification_coins_received_msg, nbtFormat.format(notificationAccumulatedAmount)) + msgSuffix;
