...
import com.matthewmitchell.nubits_android_wallet_test.R;
...
public final class InactivityNotificationService extends IntentService
{
	...
	{
		com.matthewmitchell.nubitsj.core.Context.propagate(Constants.CONTEXT);
	...
	private void handleMaybeShowNotification()
	{
		...
		if (estimatedBalance.isPositive())
		{
			...
			final StringBuilder text = new StringBuilder(getString(R.string.notification_inactivity_message, nbtFormat.format(estimatedBalance)));
