...
public final class PaymentIntent implements Parcelable
{
	...
	{
		final Output[] outputs = buildSimplePayTo(nubitsUri.getAmount(), nubitsUri.getAddress());
		final String bluetoothMac = (String) nubitsUri.getParameterByName(Bluetooth.MAC_URI_PARAM);

		return new PaymentIntent(PaymentIntent.Standard.BIP21, null, null, null, outputs, nubitsUri.getLabel(), bluetoothMac != null ? "bt:"
				+ bluetoothMac : null, null, nubitsUri.getPaymentRequestUrl());
	}
