...
package com.matthewmitchell.nubits_android_wallet.tests;
...
import com.matthewmitchell.nubits_android_wallet.util.Formats;
...
public class FormatsTest
{
    ...
    public void monetarySpannable() throws Exception
    {
        ...
        final Matcher code = Formats.PATTERN_MONETARY_SPANNABLE.matcher("Nbt 0.00");
        assertTrue(code.find());
        assertNotNull(code.group(Formats.PATTERN_GROUP_PREFIX));
        assertEquals("Nbt", code.group(Formats.PATTERN_GROUP_PREFIX));
